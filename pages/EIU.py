...
image = Image.open("media/eiu_logo.png")
st.image(image, caption="Eastern Illinois, Panthers!!!", use_column_width=True)

# st.title("2024 NCAA Season")
...
st.subheader("EIU record: 3-4 Season | 3-4 non-conference | 0-0 conference")
st.write("\n\n\n\n\n\n\n\n")
